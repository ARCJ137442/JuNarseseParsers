"""
独立时间：20230808 11:21:45
更新时间：20230814 23:04:59
"""

if !(@isdefined JuNarseseParsers)
    ...
    using JuNarseseParsers.JuNarsese # 直接使用里面的内置JuNarsese
...
sentences::Vector{AbstractSentence} = [
    ...
    nse"「「（积，『爱因斯坦』，专利局）是坐在」曾得「（外像，坐在，『爱因斯坦』，某）是专利局」」曾经真值=0.5真0.9信"han
    ...
    nse"（与，「『爱因斯坦』是物理学家」，「（外像，研发出，某，相对论）是『爱因斯坦』」）。"han
    nse"「（与，「任一人是【会死的】」，「『苏格拉底』是人」）得「『苏格拉底』是【会死的】」」。"han
    nse"「（接连，「时间是黑夜」，「程序员有写代码」，「（外像，撞上，程序员，某）是bug」）将得「程序员是【熬夜的】」」。"han
